...
doctors = Doctor.create([{name: "Meredith Grey", department: "Internal Medicine"}, {name: "Hawkeye Pierce", department: "Surgery"},{name: "Leonard 'Bones' McCoy", department: "Internal Medicine"}, {name: "Phillip Chandler", department: "Internal Medicine"}, {name: "Michaela Quinn", department: "Internal Medicine"}])

patients = Patient.create([{name: "Homer Simpson", age: 38}, {name: "Bart Simpson", age: 10}, {name: "Marge Simpson", age: 36}, {name: "Lisa Simpson", age: 8},{name: "Maggie Simpson", age: 1}])
